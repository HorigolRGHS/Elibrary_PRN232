...
import { FilterState } from "../../app/(dashboard)/dashboard/documents/types";
import { filterableColumns } from "../../app/(dashboard)/dashboard/documents/config";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuLabel,
...
export function DocumentFilters({
  ...
  const [selectedField, setSelectedField] = useState<keyof FilterState>("title");
  ...
  const selectedFieldLabel =
    filterableColumns.find((col) => col.key === selectedField)?.label || "Title";
